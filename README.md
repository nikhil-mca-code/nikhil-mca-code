...
![Brevo](https://img.shields.io/badge/Brevo-0B996E?style=for-the-badge\&logo=mailboxdotorg\&logoColor=white)
...
Google Apps Script • Google Forms • Google Sheets • JavaScript
...
## 💼 Gorakhpur Web Studio

Helping local businesses establish their digital presence through modern websites and web solutions.
...
| Project                           | Technology                   | Live Link                                    |
| --------------------------------- | ---------------------------- | -------------------------------------------- |
| 🎓 Class Orbit                    | Node.js, Express.js, MongoDB | https://class-orbit.netlify.app              |
| 👗 Maa Ladies Tailor              | Responsive Web Design        | https://maaladiestailor.in                   |
| 📋 Exam Center Help               | Google Apps Script           | https://examcenterhelp.netlify.app           |
| 🏥 Shivansh Child Development     | HTML, CSS, JavaScript        | https://shivanshchilddevelopment.netlify.app |
| 👨‍⚕️ Dr. Gopal Agarwal Portfolio | HTML, CSS, JavaScript        | https://drgopalagarwal.co.in                 |
| 💼 Gorakhpur Web Studio           | Business Website             | https://gorakhpurwebstudio.in                |
...
Arduino-based smart irrigation system using soil moisture sensors and automated watering logic.

---

## 🦯 Smart Blind Assistance Stick

Assistive device using Arduino and obstacle detection sensors to improve mobility and safety.

---

## 📖 How To Deal With Kids

Author of an eBook focused on helping parents better understand child psychology and behavior.

📚 Amazon Link:
https://amzn.in/d/0j6DpKNp
...
🥇 First Prize — School Level Science Exhibition (NCERT)

🥇 First Prize — Mandal Level Science Exhibition (NCERT)

🏅 State Level Science Exhibition Participant

💡 Participated in innovation and technology project presentations
...
[![Instagram](https://img.shields.io/badge/Instagram-@_proxy.nikhil-E4405F?style=for-the-badge\&logo=instagram\&logoColor=white)](https://www.instagram.com/_proxy.nikhil/)
...
> "Consistency, curiosity, and practical execution create real expertise."
